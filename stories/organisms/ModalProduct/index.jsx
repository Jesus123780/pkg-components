            ...
            <ContainerModal showModal={show}>
                <Modal showModal={show}>
                    <CardProductsModal>
                        ...
                        <div>
                            ...
                            <ContentInfo>
                                ...
                                <InputHooks
                                    TypeTextarea
                                    name='comments'
                                    onChange={(e) => { return setComments(e.target.value) }}
                                    value={comments}
                                />
                                {!!dataExtra?.length && <GarnishChoicesHeader>
                                    <div>
                                    ...
                                    return (
                                        <CardsComponent key={extra.exPid}>
                                            ...
                                            <QuantityButton
                                                border='none'
                                                disabled={false}
                                                handleDecrement={() => { return handleDecrementExtra({ extra, index }) }}
                                                handleIncrement={() => { return handleIncrementExtra({ extra, index }) }}
                                                padding='5px'
                        ...
                        <div></div>
                        <div style={{ display: 'flex' }} className='container-modal__actions'>
                            <QuantityButton
                                disabled={false}
