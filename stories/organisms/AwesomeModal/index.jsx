        ...
        >
          ...
          <>
            <ModalHeader>
              ...
              <BtnClose onClick={() => { return question ? onShowQuestion() : hide() }}><div size={sizeIconClose} /></BtnClose>
            </ModalHeader>
          </>
          }
          <ModalBody
          ...
          >
              ...
              <div className='modal-wrapper'>
                ...
                <div className='modal-confirm'>
                  <button
                    ...
                    type='button'
                  >{cancel || BUTTONS_TEXT.cancel}</button>
                  <button
                    border
                    onClick={() => { hide() }}
                    type={submit ? 'submit' : 'button'}
                  >{confirm || BUTTONS_TEXT.confirm}</button>
                </div>
              </div>
            }
            {children}
            {footer && <ModalFooter>
              {btnCancel ? <button
                ...
                onClick={clickCancel}
                type='button'
              >{cancel || BUTTONS_TEXT.cancel}</button> : <div></div>}
              {btnConfirm && <button
                border
